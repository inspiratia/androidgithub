...
import com.norman1.normanbhaskara.databinding.FragmentFollowBinding
import com.norman1.normanbhaskara.ui.adapters.UsersAdapter
import com.norman1.normanbhaskara.ui.viewmodels.FollowViewModel
...
class FollowFragment : Fragment() {
    ...
    private fun showError(message: String?) {
        ...
        binding.recyclerFollow.visibility = View.GONE
    }

    private fun showSuccess() {
        binding.errLayout.main.visibility = View.GONE
        binding.progress.visibility = View.GONE
        binding.recyclerFollow.visibility = View.VISIBLE
    }
